...
public class CommentMockApiCaller extends MockApiCaller {
    ...
    public ApiResponse<String> deleteComment(Long commentId) throws Exception {

        MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.delete("/api/comment/{commentId}", commentId)
                .contentType(MediaType.APPLICATION_JSON)
                .header("Authorization", "Bearer " + ADMIN_USER);
