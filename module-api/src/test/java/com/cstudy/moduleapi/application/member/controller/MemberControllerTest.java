package com.cstudy.moduleapi.application.member.controller;
...
class MemberControllerTest extends ControllerTestBase {
    ...
    void logoutWithValid() throws Exception {
        ...
        // when
        mockMvc.perform(
                        MockMvcRequestBuilders.delete("/api/member/logout")
                                .contentType(MediaType.APPLICATION_JSON)
    ...
    void refreshTokenWithValid() throws Exception {
        ...
        // when
        mockMvc.perform(
                        MockMvcRequestBuilders.post("/api/member/refreshToken")
                                .contentType(MediaType.APPLICATION_JSON)
                                .header("Authorization", "Bearer " + token)
                                .content(objectMapper.writeValueAsBytes(refreshTokenDto))
                )
    ...
    void changePassword() throws Exception {
        ...
        // when
        mockMvc.perform(
                        MockMvcRequestBuilders.patch("/api/member")
                                .contentType(MediaType.APPLICATION_JSON)
                                .header("Authorization", "Bearer " + token)
