package com.cstudy.moduleapi.application.competition.controller;
...
class CompetitionControllerTest extends ControllerTestBase {
    ...
    void getCompetitionQuestionWithValid() throws Exception {
        ...
        // when
        mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/competitions/{competitionId}/questions", competitionId)
    ...
    void getAvailableCompetitionWithValid() throws Exception {
        ...
        // when
        mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/competitions/active")
                                .contentType(MediaType.APPLICATION_JSON)
                                .header("Authorization", "Bearer " + VALID_TOKEN)
                                .content("")
                )
    ...
    void getFinishCompetitionWithValid() throws Exception {
        ...
        // when
        mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/competitions/finished")
                                .contentType(MediaType.APPLICATION_JSON)
                                .header("Authorization", "Bearer " + VALID_TOKEN)
                                .content("")
                )
    ...
    void addQuestionWithValid() throws Exception {
        ...
        // when
        mockMvc.perform(
                        MockMvcRequestBuilders.post("/api/competitions/questions")
                                .contentType(MediaType.APPLICATION_JSON)
                                .header("Authorization", "Bearer " + VALID_TOKEN)
    ...
    void getMyRanking() throws Exception {
        ...
        // when
        mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/competitions/{id}/member/rank", id)
                                .contentType(MediaType.APPLICATION_JSON)
                                .header("Authorization", "Bearer " + VALID_TOKEN)
                                .content("")
                )
    ...
    void createCompetitionWithValidParameter() throws Exception {
        ...
        // when
        mockMvc.perform(
                        MockMvcRequestBuilders.post("/api/competitions")
                                .contentType(MediaType.APPLICATION_JSON)
                                .header("Authorization", "Bearer " + VALID_TOKEN)
    ...
    void joinCompetitionByIdWithValid() throws Exception {
        ...
        // when
        mockMvc.perform(
                        MockMvcRequestBuilders.post("/api/competitions/{competitionId}/join", competitionId)
                                .contentType(MediaType.APPLICATION_JSON)
                                .header("Authorization", "Bearer " + VALID_TOKEN)
                                .content("")
                )
    ...
    void getCompetitionWithValidCompetitionId() throws Exception {
        ...
        // when
        mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/competitions/{competitionId}", competitionId)
                                .contentType(MediaType.APPLICATION_JSON)
                                .header("Authorization", "Bearer " + VALID_TOKEN)
                                .content("")
                )
